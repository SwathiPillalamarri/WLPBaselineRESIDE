...
def createSentJSON(training, sentences, entities, erels, rrels, protnum, nlp_wrapper, pp):
    for rel in erels['rels']:
...
def createRelSubObjJSON(rel, sentences, entities, erels, rrels, nlp_wrapper):
    ...
    rtest["rel"] = 'NA'#'/' + entities[arg1]['entity_type'] + '/' + entities[arg2]['entity_type'] + '/' + rel['relation_type']
